...
|---|---|---|
| **[Clarix](https://github.com/Dawood-Hamayun/Clarix)** · [live demo ↗](https://clarix-rouge.vercel.app/) | Open-source AI customer support platform — upload docs, get a production-ready support agent with citations and an embeddable widget | RAG pipeline, streaming chat with inline citations, confidence scoring, gap detection, embeddable widget, multi-tenant SaaS |
